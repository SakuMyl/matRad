classdef matRad_VoxelSquaredDeviation < DoseObjectives.matRad_DoseObjective
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods
        function obj = matRad_VoxelSquaredDeviation(penalty,dRef, voxels)

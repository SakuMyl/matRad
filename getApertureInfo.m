function apertureInfo = getApertureInfo(stf,dij,cst,pln)
...
fluenceResult = matRad_fluenceOptimization(dij, cst, pln);
...
for i = 1:numOfBeams
    ...
    wOfCurrBeams = fluenceResult.wUnsequenced(1+offset:numOfRaysPerBeam+offset);%REVIEW OFFSET
...
physicalDose = matRad_interp3(dij.doseGrid.x,dij.doseGrid.y',dij.doseGrid.z, ...
